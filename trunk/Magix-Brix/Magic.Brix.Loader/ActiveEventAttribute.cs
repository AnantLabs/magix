...
{
    /**
     * Mark your methods with this attribute to make then catch Magic.Brix Active Events. 
    ...
    public class ActiveEventAttribute : Attribute
    {
         ...
         * Magic-Brix, you cannot even access the database. However, for "fire and forget" event handlers
