...
";
                    ...
                    s1 = new WebPart.WebPartSetting();
                    s1.Name = "Magix.Brix.Components.ActiveModules.Publishing.HeaderCaption";
                    s1.Value = "Data Collection Video Tutorial";
                    t2.Settings.Add(s1);
                    o.WebParts.Add(t2);
                    ...
                    s2.Name = "Magix.Brix.Components.ActiveModules.Publishing.ContentText";
                    s2.Value = @"
<p class='mux-info-paragraph'>Watch this video to get started understanding how Data Collection using Magix works</p>
<iframe width='560' height='315' src='http://www.youtube.com/embed/f-Y9-SMW53A' frameborder='0' allowfullscreen='allowfullscreen'></iframe>
<p style='width315px;margin-top:9px;'>By default a user has been created with the username/password of admin/admin. 
<br/> You can login with this user to the Back-Web Dashboard <a href='?dashboard=true'>here</a> ...</p>
";
                    t3.Settings.Add(s2);
                    ...
                    s2 = new WebPart.WebPartSetting();
                    s2.Name = "Magix.Brix.Components.ActiveModules.MetaForms.MetaView_FormMetaFormName";
                    s2.Value = "Magix.Forms.2-Way-DataBinding";
                    ...
                    s1 = new WebPart.WebPartSetting();
                    s1.Name = "Magix.Brix.Components.ActiveModules.Publishing.HeaderCaption";
                    s1.Value = "2-Way DataBinding Explained";
                    t2.Settings.Add(s1);
                    o.WebParts.Add(t2);
                    ...
                    s2.Name = "Magix.Brix.Components.ActiveModules.Publishing.ContentText";
                    s2.Value = @"
<p class='mux-info-paragraph'>Watch this video to get started understanding how DataBinding '2-Ways' work</p>
<iframe width='560' height='315' src='http://www.youtube.com/embed/f-Y9-SMW53A' frameborder='0' allowfullscreen='allowfullscreen'></iframe>
<p style='width315px;margin-top:9px;'>By default a user has been created with the username/password of admin/admin. 
<br/> You can login with this user to the Back-Web Dashboard <a href='?dashboard=true'>here</a> ...</p>
";
